...
import 'package:social_saver/android29AndAbove/pages/display_content_saf.dart';
import 'package:social_saver/staggard_bar_manual_icons.dart';
import 'package:social_saver/android28AndBelow/widgets/main_drawer.dart';
import 'package:social_saver/android29AndAbove/providers/file_actions.dart';

class RecentStatusSaf extends StatefulWidget {
  const RecentStatusSaf(
      {Key? key, required this.isLocal, this.selectedPage = 0})
      : super(key: key);
  ...
  @override
  _RecentStatusSafState createState() => _RecentStatusSafState();
}

class _RecentStatusSafState extends State<RecentStatusSaf> {
